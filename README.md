...
- [Hub](https://github.com/activeloopai/hub) ![](https://img.shields.io/github/stars/allegroai/trains.svg?style=social) - The fastest way to store, access & manage datasets with version-control for PyTorch/TensorFlow. Works locally or on any cloud. Scalable data pipelines.
