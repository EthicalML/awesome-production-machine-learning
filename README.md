...
* [Adversarial.js](https://github.com/kennysong/adversarial.js) ![](https://img.shields.io/github/stars/kennysong/adversarial.js.svg?style=social) - Interactively generate adversarial examples for MNIST, ImageNet, GTSRB, CIFAR-10, all running in JavaScript in your browser. [Try the web demo here](https://kennysong.github.io/adversarial.js/)!
