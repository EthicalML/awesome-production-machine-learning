...
* [Adversarial.js](https://github.com/kennysong/adversarial.js) - Interactively generate adversarial examples for MNIST, ImageNet, GTSRB, CIFAR-10 with different attacks, all running in JavaScript in your browser. [Web demo here](https://kennysong.github.io/adversarial.js/).
