...
* [Counterfit](https://github.com/Azure/counterfit) - Counterfit is a command-line tool and generic automation layer for assessing the security of machine learning systems.
...
* [Plotly.NET](https://plotly.net/) - Plotly.NET provides functions for generating and rendering plotly.js charts in .NET programming languages.
